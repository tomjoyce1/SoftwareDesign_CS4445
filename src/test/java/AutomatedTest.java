...
public class AutomatedTest {
    ...
    void testFlightCreation() {
        ...
        Assertions.assertEquals("PassengerFlight", passengerFlight.getType());
        ...
        Assertions.assertEquals("MilitaryFlight", militaryFlight.getType());
    ...
    void testDifferentFlightTypes() {
        ...
        Assertions.assertEquals("CargoFlight", cargoFlight.getType());
